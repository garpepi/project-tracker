                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-around">
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" name="status" class="form-control @error('status') is-invalid @enderror" id="status" value="{{old('name', $progress_status->status)}}" placeholder="Enter status">
                                    @error('status')
