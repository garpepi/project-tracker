                            ...
                            <form action="{{ route('contracts.update', $contract->id) }}" class="col-md-12" method="POST">
                                    ...
                                    <div class="form-group col-md-6 required">
                                        ...
                                        <select name="client_id" class="form-control @error('client_id') is-invalid @enderror" id="contract.client" {{ $contract['client_id'] ? 'readonly' : '' }} required>
                                            ...
                                            <option value="{{$client->id}}"
                                                {{old('client_id', $contract->client_id) == $client->id ? 'selected': null}}>{{$client->name}}
                                            </option>
                                            @endforeach
                                        </select>
                                        @error('client_id')
                                ...
                                <div class="d-flex justify-content-center bd-highlight mb-3">
                                    <div class="p-2 bd-highlight">
                                        <a href="{{ route('contract-po') }}" class="btn btn-danger">Back</a>
                                    </div>
