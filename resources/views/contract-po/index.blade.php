                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <div class="btn-group">
                                    <form action="/contracts/{{$contract->id}}/ammend" method="get" class="d-inline">
                                ...
                                <div class="btn-group">
                                    <form action="/contracts/{{$contract->id}}" onsubmit="return confirm('Are you sure you want to delete?')" method="post" class="d-inline">
                                        @method('delete')
                                        @csrf
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <!-- show -->
                                <div class="btn-group">
                                    <form action="/projects/{{$project->id}}" method="get" class="d-inline">
                                ...
                                <!-- ammend -->
                                <div class="btn-group">
                                    <form action="/projects/{{$project->id}}/ammend" method="get" class="d-inline">
                                        <button class="btn btn-sm btn-success dropdown-hover">
                                            <i class="nav-icon fas fa-clone"></i>
                                            <div class="dropdown-menu">
                                ...
                                <!-- delete -->
                                <div class="btn-group">
                                    <form action="/projects/{{$project->id}}" onsubmit="return confirm('Are you sure you want to delete?')" method="post" class="d-inline">
                                        @method('delete')
                                        @csrf
                                        <button type="submit" class="btn btn-sm btn-danger dropdown-hover">
                                            <i class="nav-icon fas fa-trash"></i>
