            ...
            <form method="POST" action="{{ route('projects.store') }}" class="col-md-12">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-md-12" style="border:3px dashed black;">
                            ...
                            <div id="Iscontract" class="alert alert-success" style="display:none">
                                <div class="form">
                                    ...
                                    <div class="form-group col-8">
                                        ...
                                        <input type="text" class="form-control" id="volume" name="volume" value="no data" disabled="disabled">
                                    </div>
                                    <div class="form-group col-4">
                                        <label for="unit">Unit</label>
                                        <input type="text" class="form-control" id="unit" name="unit" value="no data" disabled="disabled">
                                    </div>
                                </div>
                            </div>
                        </div> --}}
                        {{-- <div class="d-flex justify-content-around">
                                                        <div class="form-group col-4">
                                                            <label for="price_contract">Total Price</label>
...
<div class="d-flex justify-content-around">
    ...
    {{-- <div class="form-group col-4">
                                        ...
                                        <input type="text" class="form-control rupiah" name="price" id="rupiah"
